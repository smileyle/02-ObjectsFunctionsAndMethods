...
def main():
    ...
    #better_draw_circles(rg.Point(-200, 0), 2)
    #even_better_draw_circles(rg.Point(100, 0), 10, 15, 'blue', 8)
    #even_better_draw_circles(rg.Point(-150, 0), 20, 25, 'purple', 2)
    even_better_draw_circles(rg.Point(0, -200), 25, 5, 'green', 2)
    even_better_draw_circles(rg.Point(0, -25), 18, 5, 'yellow', 2)
    even_better_draw_circles(rg.Point(0, 85), 10, 5, 'orange', 2)
    even_better_draw_circles(rg.Point(0, 150), 7, 5, 'red', 2)
    even_better_draw_circles(rg.Point(0, 195), 4, 5, 'black', 2)
...
def even_better_draw_circles(point, radius, howMany, color, thickness):
    ...
    for k in range(1, howMany):  # k becomes 1, 2, 3, ... 10
